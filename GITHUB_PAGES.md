...
- [Вариант 1: Ручная публикация](#вариант-1-ручная-публикация)
- [Вариант 2: Автоматический деплой через GitHub Actions](#вариант-2-автоматический-деплой-через-github-actions)
- [Проверка](#проверка)
